...
const Checkout = ({cart,addToCart,removeFromCart, subTotal}) => {
  return (
    <div className='container mx-auto'>
      <h1 className='font-semibold text-3xl mt-10 mb-7 text-center '>Checkout</h1>
      <div className='flex flex-col shadow-md py-3 px-5 rounded-md mb-10 bg-green-100 mx-5 md:mx-0'>
        <h2 className='text-2xl my-3'>Delivery Details</h2>
        <div className='flex flex-row '>
          <div class="relative mb-2 mr-4 w-[50%]">
      ...
      <div className='flex flex-col shadow-md py-3 px-5 rounded-md mb-12 bg-green-100 mx-5 md:mx-0'>
